...
parameters = [PAR_DEFAULT_LAMBDA, PAR_DEFAULT_THETA, PAR_DEFAULT_TAU, PAR_DEFAULT_BETA, PAR_DEFAULT_ALPHA, PAR_DEFAULT_TAU_U, PAR_DEFAULT_TAU_ETA, PAR_DEFAULT_TAU_CHI]
count = 0
