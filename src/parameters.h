...
#define PAR_DEFAULT_LAMBDA  23.4547299737 //41.8887721851 //40
#define PAR_DEFAULT_THETA   0.283263949386 //0.683018503834 //0.3
#define PAR_DEFAULT_TAU     0.125 //0.25

#define PAR_DEFAULT_BETA    0.701945704713 //0.025
